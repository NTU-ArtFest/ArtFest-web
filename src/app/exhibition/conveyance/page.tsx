      ...
      <div className="relative w-full min-h-screen z-10">
        ...
        <div className="md:hidden relative z-20 h-screen w-full flex flex-col">
          ...
          <div className="self-start mt-8 ml-6">
            ...
            <p className="text-xs sm:text-base tracking-wide italic">情感關係中的漫反射</p>
          </div>
                    
          {/* 右下展覽資訊 - 調整文字大小和位置以符合邊框 */}
          <div className="absolute bottom-6 right-6 text-right text-xs space-y-1">
            <p className="mb-1"><span className="font-bold text-xs">策展團隊</span><br />
            <span className="text-xs">
            李宥辰、封親靈
            </span></p>
            
            <p><span className="font-bold text-xs">參展單位</span><br />
            <span className="text-xs">陳楷恩藝術家</span></p>
            
            <p><span className="font-bold text-xs">創作團隊</span><br />
            <span className="text-xs">李宥辰、封親靈、蔡政峰、黃楷翔、劉韋杰、<br/>王厚仁、林昱安、屈言真、蘇晏禾、林冠鋐、<br/>江侑蓁、臧逸新、徐婕芸、李嘉昕、張芷嫣、<br/>陳亮穎、陳睿瀚、陳昱璇</span></p>
            
            <p><span className="font-bold text-xs">展覽時間</span><br />
            <span className="text-xs">5/2~5/16 10:00-20:00</span></p>
            
            <p><span className="font-bold text-xs">展覽地點</span><br />
            <span className="text-xs">國立臺灣大學第一學生活動中心B 藝文展示室</span></p>
          </div>
        </div>
        ...
        <div className="hidden md:block relative w-full min-h-screen z-10">
          ...
          <div className="relative h-screen w-full">
            <div className="absolute top-12 left-12">
              ...
              <p className="text-lg lg:text-xl xl:text-2xl font-light tracking-wide italic">情感關係中的漫反射</p>
            </div>

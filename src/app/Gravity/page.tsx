        ...
        <div className="relative w-full min-h-screen z-10">
          ...
          <div className="md:hidden relative z-20 h-screen w-full flex flex-col">
            ...
            <div className="absolute bottom-6 right-6 text-right text-xs space-y-1">
              ...
              <span className="text-xs">凌歆慧藝術家、臺大電影節 NTU MovieFest</span></p>
              
              <p><span className="font-bold text-xs">展覽媒材</span><br />
              <span className="text-xs">新媒體藝術裝置、互動裝置</span></p>
              ...
              <span className="text-xs">臺灣大學第一學生活動中心 一樓 103、104 展示室</span></p>
            </div>
          </div>
